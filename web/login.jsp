...
<body>
        ...
        <div class="container well">
            ...
            <div align="center">
                ...
                <img src="https://upload.wikimedia.org/wikipedia/commons/f/f4/User_Avatar_2.png" alt="Avatar" class="avatar" width="150" width="auto" style="margin:30px;">
                <form action="AccountServlet?action=login" method="post">
                    ...
                    <tr >
                        <td colspan="2"style="margin-top:20px;">
                            <input class="btn btn-info btn-lg" type="submit" name="action" value="Login" style="margin-right:20px">
